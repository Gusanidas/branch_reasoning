...
from branch_reasoning.prompts.branch_factor_2 import (
    get_format_and_examples as get_format_and_examples_branch_factor_2,
)
from branch_reasoning.prompts.branch_factor_3 import (
    get_format_and_examples as get_format_and_examples_branch_factor_3,
)
from branch_reasoning.prompts.branch_factor_4 import (
    get_format_and_examples as get_format_and_examples_branch_factor_4,
)
from branch_reasoning.prompts.no_branches import (
    get_format_and_examples as get_format_and_examples_no_branches,
)
...
def get_format_and_examples(
    branch_completions: bool, max_branching_points: int, branching_factor: int
) -> Tuple[str, List[str]]:
    if branch_completions:
        if branching_factor == 2:
            ...
            # Fallback for unsupported branching factors
